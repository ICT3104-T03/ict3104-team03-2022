...
def main():
    ...
    t0 = time.time()
    with torch.no_grad():
        progress_bar_instance = progress_bar(len(dataloader))
    ...
    os.system("ffmpeg -framerate 30 -pattern_type glob -i './datasets/demo/frames/results/P02T02C06/*.jpg' -c:v libx264 -pix_fmt yuv420p './datasets/demo/frames/results/P02T02C06/output.mp4' -hide_banner -loglevel error")
