...
if args.dataset == 'charades':
    ...
    train_split = './data/full_charades.json'
    test_split = train_split
    rgb_root =  '../pytorch-i3d/output/' 
...
def run(models, criterion, num_epochs=50):
    ...
    for epoch in range(num_epochs):
        ...
        for model, gpu, dataloader, optimizer, sched, model_file in models:
            ...
            print ("Best_val_map:",Best_val_map, "val_map", val_map)
            if Best_val_map < val_map:
                Best_val_map = val_map
                print("epoch",epoch,"Best Val Map Update",Best_val_map)
                pickle.dump(prob_val, open('./save_logit/' + args.save_file_name + str(epoch) + '.pkl', 'wb'), pickle.HIGHEST_PROTOCOL)
                print("logit_saved at:","./save_logit/" + args.save_file_name + str(epoch) + ".pkl")
